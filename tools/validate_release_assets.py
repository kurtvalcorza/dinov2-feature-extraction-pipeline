...
BYOD_GATES = ("USE_BYOD",)
EXPECTED_OUTPUTS = (
    "outputs/dinov2_feature_extraction_train.csv",
    "outputs/dinov2_feature_extraction_input_manifest.json",
    "outputs/dinov2_feature_extraction_evaluation_report.json",
    "outputs/dinov2_feature_extraction_predictions.csv",
    "outputs/dinov2_feature_extraction_adapter",
    "outputs/dinov2_feature_extraction_result.json",
)
CODE_MARKERS = (
    ...
    "write_dataset_csv(train_records, 'outputs/dinov2_feature_extraction_train.csv')",
    ...
    "'contract': {'EMBED_DIM': EMBED_DIM, 'POOLING': POOLING, 'NORMALIZED': NORMALIZED, 'TRANSFORMER_BLOCKS': TRANSFORMER_BLOCKS, 'PARAMETER_COUNT': PARAMETER_COUNT}",
    "'unit_norm': bool(embedding_result['normalized'])",
    "'cosine_same_species'",
...
MARKDOWN_MARKERS = (
    ...
    "a linear probe on the frozen features with an optional unfreeze of the last transformer blocks",
    ...
    "object detection, segmentation, captioning, image-text comparison, patch-level (dense) features",
...
EXTERNAL_WEIGHT_BYTES: dict[int, str] = {
    19_183_071: "180 pinned iNaturalist tutorial photographs, total",
}
